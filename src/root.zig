...
pub const kb = struct {
    ...
    pub const metrics = @import("kb/metrics.zig");
    pub const init = @import("kb/init.zig");
    pub const predict = @import("kb/predict.zig");
    ...
    pub const curator = @import("kb/curator.zig");
